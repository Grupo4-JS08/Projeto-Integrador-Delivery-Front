  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_420px] gap-10 items-start">
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <img src="/infoContato.png" alt="" className="w-12" />
              ...
              <div>
                ...
                <ul className="mt-3 space-y-1">
                  ...
                  <li className="text-[13.5px] font-semibold text-slate-900">
                    Envie seu currículo para: rh@devlivery.app
                  </li>
                  <li className="text-[13.5px] font-extrabold text-slate-900">
                    Contato
                  </li>
      ...
      <section className="container mx-auto px-4 pb-16">
        ...
        <div className="mt-6 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto justify-center">
          {PARCEIROS.map((p) => (
            <a
              key={p.nome}
              href={p.url}
            ...
            >
              <div className="w-[280px] h-[140px] grid grid-rows-[1fr_auto] place-items-center rounded-2xl border border-gray-200 bg-white p-4 shadow-sm hover:shadow-md transition">
