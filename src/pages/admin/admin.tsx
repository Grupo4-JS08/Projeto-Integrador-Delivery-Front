...
type ObjetivoType = "geral" | "emagrecer" | "hipertrofia";

function Admin() {
  const { usuario, handleLogout } = useContext(AuthContext);
  const [produtos, setProdutos] = useState<Produto[]>([]);
  const [categorias, setCategorias] = useState<Categoria[]>([]);
  const [abaAtiva, setAbaAtiva] = useState<"produtos" | "categorias">(
    "produtos"
  );
  ...
  const [novoProduto, setNovoProduto] = useState({
    ...
    valor: 0,
    calorias: 0,
    objetivo: "geral" as ObjetivoType,
  ...
  const handleCriarProduto = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await cadastrar("/produtos", novoProduto, {
        headers: { Authorization: `Bearer ${usuario.token}` },
      });
      setNovoProduto({
        item: "",
  ...
  const handleEditarProduto = async (e: React.FormEvent) => {
    ...
    try {
      await atualizar("/produtos", editandoProduto, {
        headers: { Authorization: `Bearer ${usuario.token}` },
      });
  ...
  const handleEditarCategoria = async (e: React.FormEvent) => {
    ...
    try {
      await atualizar("/categorias", editandoCategoria, {
        headers: { Authorization: `Bearer ${usuario.token}` },
      });
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-[#7E8C54]">
      ...
      {abaAtiva === "produtos" && (
        <div>
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <form
              onSubmit={
                editandoProduto ? handleEditarProduto : handleCriarProduto
              }
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    value={
                      editandoProduto ? editandoProduto.item : novoProduto.item
                    }
                    onChange={(e) =>
                      editandoProduto
                        ? setEditandoProduto({
                ...
                <div>
                  ...
                  <select
                    ...
                    value={
                      editandoProduto
                        ? editandoProduto.objetivo
                        : novoProduto.objetivo
                    }
                    onChange={(e) => {
                      const value = e.target.value as ObjetivoType;
                      if (editandoProduto) {
                        setEditandoProduto({
                          ...editandoProduto,
                          objetivo: value,
                        ...
                        setNovoProduto({ ...novoProduto, objetivo: value });
                      }
                    }}
                    required
                  >
      ...
      {abaAtiva === "categorias" && (
        <div>
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <form
              onSubmit={
                editandoCategoria ? handleEditarCategoria : handleCriarCategoria
              }
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
